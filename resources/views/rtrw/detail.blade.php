                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Persetujuan</th>
                            <td>
                                @if($surat->persetujuan === 0)
                                    <span class="badge badge-danger">Ditolak</span>
                                @elseif($surat->persetujuan === 1)
                                    <span class="badge badge-warning">Belum Divalidasi</span>
                                @elseif($surat->persetujuan === 2)
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>File KTP</th>
                            <td>
                                @if(!empty($surat->detailSurat->path_ktp))
                                    <a href="{{ asset('storage/' . $surat->detailSurat->path_ktp) }}" target="_blank">Download KTP</a>
                                @else
                                    -
                                @endif
                            </td>
                        ...
                        <tr>
                            <th>File KK</th>
                            <td>
                                @if(!empty($surat->detailSurat->path_kk))
                                    <a href="{{ asset('storage/' . $surat->detailSurat->path_kk) }}" target="_blank">Download KK</a>
                                @else
                                    -
                                @endif
                            </td>
                        ...
                        <tr>
                            <th>RT/RW</th>
                            <td>{{ str_pad($surat->detailSurat->rt ?? '-', 2, '0', STR_PAD_LEFT) }}/{{ str_pad($surat->detailSurat->rw ?? '-', 2, '0', STR_PAD_LEFT) }}</td>
                        </tr>
                        <tr>
